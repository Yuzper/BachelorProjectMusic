...
trainingData = tf.keras.utils.image_dataset_from_directory(
    directory = "SpectrogramData/training_Aug2",
    labels="inferred",
...
csv_file = "Results/Aug2_metrics.csv"
...
bestModelArchitecture.save("Results/SavedModels/best_model_Aug2.h5")
